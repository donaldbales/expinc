...
// gcc ncurses2.c -g -o ncurses2 -lncursesw_g
// env NCURSES_TRACE=1 ncurses2 2>ncurses2.err
...
int main(/*@unused@*/ int argc, /*@unused@*/ char *argv[])
{
	...
	if (has_colors())
	{
		_tracef("DJB: %s", "has colors");
	}

	if (has_mouse())
	{
		_tracef("DJB: %s", "has mouse before mousemask");
	}
//	if (has_mouse())
//	{
...
//	}
	if (has_mouse())
	{
		_tracef("DJB: %s", "has mouse after mousemask");
	}
	for (;;)
	{
		int ch = getch();
		...
		switch(ch)
		{
			...
			case KEY_MOUSE:
				...
				else if ((mevent.bstate & BUTTON1_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON1_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON1_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON1_PRESSED");
				}
				else if ((mevent.bstate & BUTTON1_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON1_RELEASED");
				}
				//else if ((mevent.bstate & BUTTON1_RESERVED_EVENT) != 0)
				//{
				//	_tracef("DJB: %s", "BUTTON1_RESERVED_EVENT");
				//}
				else if ((mevent.bstate & BUTTON1_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON1_TRIPLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON2_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON2_CLICKED");
				}
				else if ((mevent.bstate & BUTTON2_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON2_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON2_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON2_PRESSED");
				}
				else if ((mevent.bstate & BUTTON2_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON2_RELEASED");
				}
				//else if ((mevent.bstate & BUTTON2_RESERVED_EVENT) != 0)
				//{
				//	_tracef("DJB: %s", "BUTTON2_RESERVED_EVENT");
				//}
				else if ((mevent.bstate & BUTTON2_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON2_TRIPLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON3_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON3_CLICKED");
				}
				else if ((mevent.bstate & BUTTON3_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON3_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON3_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON3_PRESSED");
				}
				else if ((mevent.bstate & BUTTON3_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON3_RELEASED");
				}
				//else if ((mevent.bstate & BUTTON3_RESERVED_EVENT) != 0)
				//{
				//	_tracef("DJB: %s", "BUTTON3_RESERVED_EVENT");
				//}
				else if ((mevent.bstate & BUTTON3_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON3_TRIPLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON4_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON4_CLICKED");
				}
				else if ((mevent.bstate & BUTTON4_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON4_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON4_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON4_PRESSED");
				}
				else if ((mevent.bstate & BUTTON4_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON4_RELEASED");
				}
				//else if ((mevent.bstate & BUTTON4_RESERVED_EVENT) != 0)
				//{
				//	_tracef("DJB: %s", "BUTTON4_RESERVED_EVENT");
				//}
				else if ((mevent.bstate & BUTTON4_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON4_TRIPLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON5_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON5_CLICKED");
				}
				else if ((mevent.bstate & BUTTON5_DOUBLE_CLICKED) != 0)
				{
				...
				else if ((mevent.bstate & BUTTON5_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON5_RELEASED");
				}
				else if ((mevent.bstate & BUTTON5_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON5_TRIPLE_CLICKED");
				}
				/*else if ((mevent.bstate & BUTTON6_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON6_CLICKED");
				}
				else if ((mevent.bstate & BUTTON6_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON6_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON6_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON6_PRESSED");
				}
				else if ((mevent.bstate & BUTTON6_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON6_RELEASED");
				}
				else if ((mevent.bstate & BUTTON6_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON6_TRIPLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON7_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON7_CLICKED");
				}
				else if ((mevent.bstate & BUTTON7_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON7_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON7_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON7_PRESSED");
				}
				else if ((mevent.bstate & BUTTON7_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON7_RELEASED");
				}
				else if ((mevent.bstate & BUTTON7_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON7_TRIPLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON8_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON8_CLICKED");
				}
				else if ((mevent.bstate & BUTTON8_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON8_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON8_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON8_PRESSED");
				}
				else if ((mevent.bstate & BUTTON8_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON8_RELEASED");
				}
				else if ((mevent.bstate & BUTTON8_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON8_TRIPLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON9_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON9_CLICKED");
				}
				else if ((mevent.bstate & BUTTON9_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON9_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON9_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON9_PRESSED");
				}
				else if ((mevent.bstate & BUTTON9_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON9_RELEASED");
				}
				else if ((mevent.bstate & BUTTON9_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON9_TRIPLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON10_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON10_CLICKED");
				}
				else if ((mevent.bstate & BUTTON10_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON10_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON10_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON10_PRESSED");
				}
				else if ((mevent.bstate & BUTTON10_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON10_RELEASED");
				}
				else if ((mevent.bstate & BUTTON10_TRIPLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON10_TRIPLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON11_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON11_CLICKED");
				}
				else if ((mevent.bstate & BUTTON11_DOUBLE_CLICKED) != 0)
				{
					_tracef("DJB: %s", "BUTTON11_DOUBLE_CLICKED");
				}
				else if ((mevent.bstate & BUTTON11_PRESSED) != 0)
				{
					_tracef("DJB: %s", "BUTTON11_PRESSED");
				}
				else if ((mevent.bstate & BUTTON11_RELEASED) != 0)
				{
					_tracef("DJB: %s", "BUTTON11_RELEASED");
				}
				else if ((mevent.bstate & BUTTON11_TRIPLE_CLICKED) != 0)
				{
